...
func TestBadgerCache_Empty(t *testing.T) {
	...
	if inCache {
		t.Error("alpha found in cache, and in shouldn't be there")
	}
}
...
func TestBadgerCache_EmptyByMatch(t *testing.T) {
	...
	if inCache {
		t.Error("alpha2 found in cache, and in shouldn't be there")
	}
	...
	if !inCache {
		t.Error("beta found in cache, and in should be there")
	}
}
