...
func (v *Validation) IsInt(field, value string) {
	...
	if err != nil {
		v.AddError(field, "This field must ba an integer")
	}
}
...
func (v *Validation) IsFloat(field, value string) {
	...
	if err != nil {
		v.AddError(field, "This field must ba a floating point number")
	}
}
...
func (v *Validation) IsDateISO(field, value string) {
	...
	if err != nil {
		v.AddError(field, "This field must ba a data in the form of YYYY-MM-DD")
	}
}
